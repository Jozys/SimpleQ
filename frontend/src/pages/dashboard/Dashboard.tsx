        ...
        items={[
          {
            ...
            hidden: auth.getToken() === undefined,
          },
          {
    ...
    <div className={"dashboard"}>
      ...
      <nav>
        <div style={{ position: "relative", overflow: "hidden" }}>
          ...
          <i
            className={"fi fi-rr-circle-xmark toggle-nav"}
            style={{
              fontSize: "1.5em",
              cursor: "pointer",
              position: "absolute",
        ...
        {props.activeQuestion && (
          <>
            <NavLink
              to={"question/" + props.activeQuestion.id}
              className={"navigate"}
              onClick={(e) => animateBlob(e)}
            >
              <i
                className={
                  "fi fi-" +
                  (window.location.pathname.includes("/question") ? "s" : "r") +
                  "r-question-square"
                }
              />
              <div
              ...
              >
                <p className={"caption"}>
                  {window.location.pathname.includes("/question")
                    ? t("dashboard.nav.question.browsing.currently", {
                        type: props.activeQuestion.isDiscussion
                          ? t("components.question.type.discussion")
                          : t("components.question.type.question"),
                      })
                    : t("dashboard.nav.question.browsing.recently", {
                        type: props.activeQuestion.isDiscussion
                          ? t("components.question.type.discussion")
                          : t("components.question.type.question"),
                      })}
          ...
          <>
            ...
            >
              {({ isActive }) => (
                <>
                  <i
                    className={
                      "fi fi-" + (isActive ? "s" : "r") + "r-introduction"
                    }
                  />
            ...
            >
              {({ isActive }) => (
                <>
                  <i
                    className={
                      "fi fi-" + (isActive ? "s" : "r") + "r-treasure-chest"
                    }
                  />
                  <span className={"nav-label"}>
            ...
            >
              {({ isActive }) => (
                <>
                  <i
                    className={
                      "fi fi-" + (isActive ? "s" : "r") + "r-list-timeline"
                    }
                  />
                  <span className={"nav-label"}>
            ...
            >
              {({ isActive }) => (
                <>
                  <i
                    className={"fi fi-" + (isActive ? "s" : "r") + "r-envelope"}
                  />
                  <span className={"nav-label"}>
            ...
            <div style={{ paddingInline: "var(--spacing)" }}>
              ...
              <p
                className={"caption"}
                style={{ textAlign: "center", marginBottom: "var(--spacing)" }}
              >
      ...
      <main>
        <div className={"container transparent top-bar"}>
          <i
            className={"fi fi-rr-menu-burger glass toggle-nav"}
          ...
          >
            ...
            >
              {t("dashboard.search.search")} {getSearchShortcut()}
            </span>
          </p>
