...
export default function Editor(props: {}) {
  ...
  return (
    <>
      <section
        className={"container editor-container transparent focus-indicator"}
      >
        <div className={"editor-hints"}>
          <span className={"hint-number"}>1.</span>
          <span className={"caption"}>
            {t("dashboard.questionEditor.title.caption")}
          </span>
        </div>

        <input
          type={"text"}
          id={"editor-question-title"}
          minLength={4}
          maxLength={50}
          required
          onInput={(e) => {
      ...
      >
        <div className={"editor-hints"}>
          ...
          <span className={"caption"}>
            {t("dashboard.questionEditor.tags.caption")}
          </span>
        </div>
        ...
        <div className={"glass"}>
          ...
          <div style={{ display: "flex", gap: "var(--spacing)" }}>
            <LiveInput
              placeholder={t("dashboard.questionEditor.tags.placeholder")}
              onSuggestionSelected={(s) => setTags([...tags, s])}
              onSuggestionDeselected={(s) =>
                setTags(tags.filter((t) => t !== s))
              }
              disabled={hasBeenSubmitted || tags.length >= 5}
              selectedSuggestions={tags}
            />
            <p
              className={"tags tags-deletable"}
      ...
      >
        <div className={"editor-hints"}>
          ...
          <span className={"caption"}>
            {t("dashboard.questionEditor.description.caption")}
          </span>
        </div>
      ...
      <section className={"container editor-container transparent"}>
        <div className={"editor-hints"}>
          ...
          <span className={"caption"}>
            {t("dashboard.questionEditor.type.caption")}
          </span>
        </div>

        <div
          className={
            "glass editor-question-type-select" +
        ...
        >
          <i
            className={"fi fi-sr-brain icon-test"}
            style={{ fontSize: "2em" }}
          />
          ...
          <span className={"caption"}>
            {t("dashboard.questionEditor.type.simp.model")}
          </span>
        ...
        >
          <i
            className={"fi fi-sr-user icon-test"}
            style={{ fontSize: "2em" }}
          />
      ...
      <div
        className={"container editor-container transparent"}
        style={{ display: "flex" }}
      >
        <div style={{ flex: 1 }} />
        <Button
          buttonStyle={"primary"}
          iconLeft={"fi fi-rr-paper-plane"}
          onClick={async () => {
            ...
            await global.axios
              .post("question/create", {
                ...
                tags: tags,
                content: description,
                useAI: questionType === "simp" ? selectedAI : "none",
              })
