    ...
    <div className={"home"}>
      <nav>
        <div className={"nav-wrapper"}>
          ...
          <Dropdown
            button={<Button iconLeft={"fi fi-rr-gears"}>Appearance</Button>}
            items={[
              {
              ...
              },
              {
                ...
                shortcut: capitalizeFirstLetter(
      ...
      <main>
            ...
            <div style={{ position: "relative" }}>
              <div
                ...
                style={{
                  ...
                  opacity: 0.6,
                  background:
                    "linear-gradient(to right, var(--primary-color), transparent), url(public/noise.svg)",
                }}
              />
              <div
                className={"home-bg-blob"}
                ...
                style={{
                  ...
                  background:
                    "linear-gradient(to left, var(--background-color-glass-simp), transparent), url(public/noise.svg)",
                }}
              />

              <h1 className={"title"}>
                Try Our Q&A Platform
                <br />
              ...
              >
                ...
                <Button
                  iconLeft={"fi fi-brands-github"}
                  onClick={async () => {
                    window.open(
                      "https://github.com/SE-TINF22B2/G6-SimpleQ",
                      "_blank"
                    );
                  }}
                >
        ...
        <section className={"page"} id={"features"}>
          <div>
            ...
            <p className={"page-summary fade-in"}>
              We offer a wide range of features to help you with your daily
              tasks.
            </p>
            <Button
              buttonStyle={"primary"}
        ...
        <section className={"page bg-secondary"} id={"developers"}>
          <div>
            ...
            <p className={"page-summary fade-in"}>
              This is the team behind simpleq. We are a group of students from
              the DHBW Karlsruhe in Germany and are excited to develop this
              platform.
            </p>
            ...
            <div className={"members"}>
              <div className={"member fade-in"}>
                ...
                <div className={"member-details"}>
                  ...
                  <div className={"member-socials"}>
                    <a
                      href={"https://github.com/benniloidl"}
                      target={"_blank"}
                      rel={"noreferrer"}
                    >
              ...
              <div className={"member fade-in"}>
                ...
                <div className={"member-details"}>
                  ...
                  <div className={"member-socials"}>
                    ...
                    <a
                      href={"https://www.riedbahn.de/home.html"}
                      target={"_blank"}
                      rel={"noreferrer"}
                    >
                      <i className={"fi fi-brands-discord"} />
              ...
              <div className={"member fade-in"}>
                ...
                <div className={"member-details"}>
                  ...
                  <div className={"member-socials"}>
                    <a
                      href={"https://github.com/michalskyl"}
                      target={"_blank"}
                      rel={"noreferrer"}
                    >
                      <i className={"fi fi-brands-github"} />
              ...
              <div className={"member fade-in"}>
                ...
                <div className={"member-details"}>
                  ...
                  <div className={"member-socials"}>
                    <a
                      href={"https://github.com/manuelbrs"}
                      target={"_blank"}
                      rel={"noreferrer"}
                    >
                      <i className={"fi fi-brands-github"} />
                    ...
                    <a
                      href={"https://brink.ws/lokalpolitiker"}
                      target={"_blank"}
                      rel={"noreferrer"}
                    >
                      <i className={"fi fi-brands-discord"} />
              ...
              <div className={"member fade-in"}>
                ...
                <div className={"member-details"}>
                  ...
                  <div className={"member-socials"}>
                    <a
                      href={"https://github.com/integraluminium"}
                      target={"_blank"}
                      rel={"noreferrer"}
                    >
                      <i className={"fi fi-brands-github"} />
                    ...
                    <a
                      href={"https://www.youtube.com/watch?v=wXjhszy2f9w"}
                      target={"_blank"}
                      rel={"noreferrer"}
                    >
                      <i className={"fi fi-brands-discord"} />
        ...
        <section className={"page"} id={"development"}>
          <div>
            ...
            <h1 className={"page-subtitle fade-in"}>
              Follow and take part in the process
            </h1>
            <p className={"page-summary fade-in"}>
              We are currently under development and are looking for
              contributors to help us improve our platform. Furthermore, we
              enable users to test our platform and provide feedback.
            </p>
            ...
            <div className={"dev-tl"}>
              ...
              <div className={"dev-tl-step done fade-in"}>
                <div className={"dev-tl-icons"}>
                  <i
                    className={"fi fi-rr-brush"}
                    style={{ top: "35%", left: "70%" }}
                  />
                  <i
                    className={"fi fi-rr-pen-nib"}
              ...
              <div className={"dev-tl-step incoming fade-in"}>
                <div className={"dev-tl-icons"}>
                  <i
                    className={"fi fi-rr-quiz"}
                    style={{ top: "40%", left: "35%" }}
                  />
                  <i
                    className={"fi fi-rr-clipboard"}
            ...
            >
              ...
              />
              <span>
                For further information, please have a look at the Wiki linked
        ...
        <section className={"page bg-secondary"} id={"plans"}>
          <div>
            ...
            <p className={"page-summary fade-in"}>
              Take a look at our convenient plans that intend to improve your
              question-related workflows even more.
            </p>
        ...
        <section className={"page"}>
          <div>
            ...
            <p className={"page-summary"}>
              Instead of reading this, you could have already submitted your
